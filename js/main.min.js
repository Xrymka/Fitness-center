...
/* harmony import */ var _modules_send_form__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/send-form */ "./js/modules/send-form.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_trainers_slider__WEBPACK_IMPORTED_MODULE_5__["initSwiperTrainer"])(swiper);
  Object(_modules_trainers_slider__WEBPACK_IMPORTED_MODULE_5__["renderSlidesOrder"])();
  Object(_modules_reviews_slider__WEBPACK_IMPORTED_MODULE_6__["initSwiperReviews"])(swiper);
  window.addEventListener('load', function () {
    Object(_modules_modals_init_modals__WEBPACK_IMPORTED_MODULE_1__["initModals"])();
    Object(_modules_video__WEBPACK_IMPORTED_MODULE_3__["videoEnabled"])();
    Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_4__["openTab"])();
    Object(_modules_phone_mask__WEBPACK_IMPORTED_MODULE_7__["initPhoneMask"])();
    Object(_modules_send_form__WEBPACK_IMPORTED_MODULE_8__["initForm"])();
  });
});
...
var initSwiperReviews = function initSwiperReviews(swiper) {
  if (swiper) {
    var swiperReviews = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('[data-slider="reviews-slider"]', {
...
var tabBtn = document.querySelectorAll('.tab__button');
  ...
  if (tab) {
    tab.addEventListener('click', function (e) {
      if (e.target.classList.contains('tab__button')) {
        var tabPath = e.target.dataset.tabsPath;
        tabBtn.forEach(function (el) {
          el.classList.remove('is-active');
        });
        document.querySelector("[data-tabs-path=\"".concat(tabPath, "\"]")).classList.add('is-active');
        tabHandler(tabPath);
      }
    });
  }
};
var tabHandler = function tabHandler(path) {
  tabContent.forEach(function (el) {
    el.classList.remove('is-open');
  });
  document.querySelector("[data-tabs-content=\"".concat(path, "\"]")).classList.add('is-open');
};
...
/*!***************************************!*\
  !*** ./js/modules/trainers-slider.js ***!
  \***************************************/
/*! exports provided: initSwiperTrainer, renderSlidesOrder */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initSwiperTrainer", function() { return initSwiperTrainer; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "renderSlidesOrder", function() { return renderSlidesOrder; });
/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! swiper */ "../node_modules/swiper/swiper.esm.js");

var initSwiperTrainer = function initSwiperTrainer(swiper) {
  if (swiper) {
    var swiperTrainers = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('[data-slider="trainers-slider"]', {
      modules: [swiper__WEBPACK_IMPORTED_MODULE_0__["Navigation"]],
      navigation: {
...
var renderSlidesOrder = function renderSlidesOrder() {
  var duplicateSlides = document.querySelectorAll('.swiper-slide-duplicate.slider__trainer');
